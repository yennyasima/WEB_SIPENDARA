...
@section('title', 'SIPENDARA')

@section('content')
    <div class="flex flex-col justify-center items-center px-4 md:px-[200px] py-[40px] mt-[100px]">
        <h1 class="font-Anek font-bold text-[32px] md:text-[64px] text-[#D95639]" data-aos="fade-up" data-aos="fade-up">EDUKASI
        </h1>
        <p class="md:text-center text-justify pt-2 text-lg sm:text-xl md:text-[24px] mb-5 md:px-[250px] font-inter text-black ont-extralight"
            data-aos="fade-up">
            Temukan update edukasi dan informasi terkini seputar penyakit DBD.
</br>
</br>
