    ...
    <div class="page-content" style="min-width: calc(100vw - 300px);">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.hotspot-hiv.index') }}">Hotspot HIV</a></li>
        ...
        <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.hotspot-hiv.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
