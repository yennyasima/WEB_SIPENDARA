...
@section('title', 'Edit Fasilitas Kesehatan')
    ...
    <div class="page-content" style="min-width: calc(100vw - 300px);">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.faskes-pdp-hiv.index') }}">Fasilitas Kesehatan</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Edit Fasilitas Kesehatan</li>
            </ol>
        </nav>
