...
class HotspotHivController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.hotspot-hiv.index')->with('success', 'Data Berhasil Disimpan!');
    }
     ...
     */
    public function edit(HotspotHiv $hotspotHiv)
    {
        return view('pages.admin.HIV.hotspotHiv.edit', compact('hotspotHiv'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('admin.hotspot-hiv.index')->with('success', 'Data berhasil diperbarui!');
    }
    ...
    public function destroy($id)
    {
        ...
        $hotspotHiv->delete();
        return redirect()->route('admin.hotspot-hiv.index')->with('success', 'Data Hotspot HIV berhasil dihapus!');
    }
}
